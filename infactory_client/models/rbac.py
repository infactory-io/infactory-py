...
class Rbac(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["id", "role_name", "permissions", "user_id", "team_id", "created_at", "updated_at", "teams", "users"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "permissions": AnyOf.from_dict(obj["permissions"]) if obj.get("permissions") is not None else None,
...
Rbac.model_rebuild(raise_errors=False)
