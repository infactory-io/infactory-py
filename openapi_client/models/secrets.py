...
class Secrets(BaseModel):
    ...
    credentials_id: Optional[StrictStr] = Field(default=None, alias="credentialsId")
    credentials: Optional[Credentials] = None
    teams: Optional[Teams] = None
    __properties: ClassVar[List[str]] = ["id", "key", "value", "team_id", "type", "created_at", "updated_at", "credentialsId", "credentials", "teams"]
...
Secrets.model_rebuild(raise_errors=False)
