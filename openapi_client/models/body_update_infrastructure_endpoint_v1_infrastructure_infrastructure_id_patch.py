...
class BodyUpdateInfrastructureEndpointV1InfrastructureInfrastructureIdPatch(BaseModel):
    """
    BodyUpdateInfrastructureEndpointV1InfrastructureInfrastructureIdPatch
    """ # noqa: E501
    resources_allocated: Optional[Dict[str, Any]] = None
    limits: Optional[Dict[str, Any]] = None
    __properties: ClassVar[List[str]] = ["resources_allocated", "limits"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "resources_allocated": obj.get("resources_allocated"),
