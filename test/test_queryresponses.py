...
class TestQueryresponses(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> Queryresponses:
        """Test Queryresponses
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `Queryresponses`
        """
        model = Queryresponses()
        if include_optional:
            return Queryresponses(
                ...
                queryprograms = openapi_client.models.queryprograms.queryprograms(
                    id = '', 
                    dataline_id = '', 
                    created_at = datetime.datetime.strptime('2013-10-20 19:20:30.00', '%Y-%m-%d %H:%M:%S.%f'), 
                    updated_at = datetime.datetime.strptime('2013-10-20 19:20:30.00', '%Y-%m-%d %H:%M:%S.%f'), 
